...
function Start () {
	...
	mySpawnStopper.transform.position=Vector3(mySpawnStopper.transform.position.x,mySpawnStopper.transform.position.y,myLvlFinished.transform.position.z-115);
}
